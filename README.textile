...
oui_audio version 1.0.0-BETA3, Copyright (C) 2018 Nicolas Morand
...
* *oui_audio v1.0.0-BETA3* (2018-07-04)
** Added: MIME types managements;
** added: player width management;
** added: @.aac@ and @.flac@ support;
** changed: does not try to play non existing files (triggers errors).
